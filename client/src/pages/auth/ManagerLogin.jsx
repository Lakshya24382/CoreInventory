  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-md">
        ...
        <p className="text-gray-500 text-sm mb-6">Enter your manager credentials</p>
        ...
        <Link to="/" className="flex items-center justify-center gap-1 text-sm text-gray-400 hover:text-gray-600 mt-5">
